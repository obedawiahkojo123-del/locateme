    ...
    channel
      .on(
        ...
        (payload) => {
          ...
          if (updated.arrived) {
            alert(
              "A receiver has arrived at their destination."
            );
          }
        }
      )
          ...
          <div className="grid gap-4">
            ...
            {recentLocations.map(
              (loc) => {
                ...
                const uberLink =
                  `https://m.uber.com/ul/?action=setPickup&dropoff[latitude]=${loc.latitude}&dropoff[longitude]=${loc.longitude}&dropoff[nickname]=${encodeURIComponent(
                    loc.place_name ||
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        {loc.arrived && (
                          ...
                          <div className="mt-4 bg-green-500 text-black rounded-xl px-4 py-3 inline-flex items-center gap-2 font-semibold">
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <a
                          href={uberLink}
                          className="bg-black border border-zinc-700 px-5 py-3 rounded-2xl font-semibold flex items-center gap-2"
                        >
                          <Car size={16} />
